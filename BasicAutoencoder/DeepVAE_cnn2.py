...
# -*- coding: utf-8 -*-
"""
Created on Mon Dec 17 23:25:46 2018
...
if __name__ == "__main__":
    ...
    for noise_factor in noise_factors:
        ...
        x_train_noisy = X_in + noise_factor * np.random.normal(loc=0.0, scale=1.0, size=X_in.shape) 
        ...
        with tf.Session() as sess:
            ...
            cnnvae.fit(x_train_noisy, path = path, file_name="", num_epoch = 30, batch_size = batch_size,keep_prob = 1.0)
